...
cookbook 'osl-resources', git: 'git@github.com:osuosl-cookbooks/osl-resources',
branch: 'main'
...
cookbook 'osl-imap', git: 'git@github.com:osuosl-cookbooks/osl-imap'

cookbook 'mailstore-test', path: 'test/cookbooks/mailstore-test'
